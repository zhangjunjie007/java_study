...
[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(img-NVQ5IFbw-1661819077024)(https://leviathan.vip/2019/03/20/InnoDB%E7%9A%84%E4%BA%8B%E5%8A%A1%E5%88%86%E6%9E%90-MVCC/trans_visible.jpg)]
...
![](https://img-blog.csdnimg.cn/img_convert/a081c42e850cc70bbc2750763cefa360.png)

2. **`update undo log`** ：`update` 或 `delete` 操作中产生的 `undo log`。该 `undo log`可能需要提供 `MVCC` 机制，因此不能在事务提交时就进行删除。提交时放入 `undo log` 链表，等待 `purge线程` 进行最后的删除

**数据第一次被修改时：**

![](https://img-blog.csdnimg.cn/img_convert/b39c25370ccd05e86af00343e381b975.png)

**数据第二次被修改时：**

![](https://img-blog.csdnimg.cn/img_convert/7128d8bbde5f25c0ded306b44788018c.png)
...
![](https://img-blog.csdnimg.cn/img_convert/d5986382aa66aabfd7e6494a7a50885f.png)
...
![](https://img-blog.csdnimg.cn/img_convert/87aab67d7194fd6cf9bc26d0f9f4b3cf.png)

### 在 RC 下 ReadView 生成情况

1. **`假设时间线来到 T4 ，那么此时数据行 id = 1 的版本链为`：**

   ![](https://img-blog.csdnimg.cn/img_convert/340d6cd4150cd3675ea6961fb61113d1.png)
...
2. **`时间线来到 T6 ，数据的版本链为`：**
   ...
   ![markdown](https://img-blog.csdnimg.cn/img_convert/3a24ad82c3ec2a8065260b3259a928a9.png)
...
![markdown](https://img-blog.csdnimg.cn/img_convert/652f97955a3360f3a89d353b43bd7914.png)
...
![markdown](https://img-blog.csdnimg.cn/img_convert/b707ab10499363aea1ed2ff0b0d6dea2.png)
...
2. **`时间点 T6 情况下`：**
   ...
   ![markdown](https://img-blog.csdnimg.cn/img_convert/ca58d298d075e58062e6372be23ec0ae.png)
...
![markdown](https://img-blog.csdnimg.cn/img_convert/afb727f21d696399f96af02365144939.png)
